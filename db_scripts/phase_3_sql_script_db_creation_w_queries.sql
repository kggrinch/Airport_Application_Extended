...
(
    	...
    	CONSTRAINT fk_airport_location
    		...
    		ON DELETE RESTRICT -- Prevent deletion of airport_location
...
INSERT INTO customer (first_name, last_name, username, password, email, phone, passport_number) VALUES
('Alice', 'Smith', 'asmith', 'pass123', 'alice.smith@example.com', '111-222-3333', 'PS123456'),
('Bob', 'Johnson', 'bjohnson', 'securepwd', 'bob.j@example.com', '444-555-6666', 'PS789012'),
('Charlie', 'Brown', 'cbrown', 'mysecret', 'cbrownie@example.com','777-888-9999', 'PS345678'),
('Diana', 'Prince', 'dprince', 'wonderw', 'diana.p@example.com', '222-333-4444', 'PS901234'),
('Eve', 'Adams', 'eadams', 'evypass', 'eve.a@example.com', '555-666-7777', 'PS567890'),
('Frank', 'White', 'fwhite', 'frankpwd', 'frank.w@example.com', '888-999-0000', 'PS654321'),
('Grace', 'Taylor', 'gtaylor', 'gracet', 'grace.t@example.com', '123-456-7890', 'PS098765'),
('Henry', 'Miller', 'hmiller', 'henry_m', 'henry.m@example.com', '321-654-9870', 'PS246813'),
('Ivy', 'Davis', 'idavis', 'ivy_d', 'ivy.d@example.com', '987-654-3210', 'PS135792'),
('Jack', 'Garcia', 'jgarcia', 'jackg', 'jack.g@example.com', '987-654-3212', 'PS864209'),
('Jerry', 'Jones', 'jjones', 'jj123', 'JerrJ.g@example.com', '967-694-3112', 'PS864569');
